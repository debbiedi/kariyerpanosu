...
  // --- ANA YAPI (Fixed Layout Fix) ---
  return (
    // Bu 'h-screen' ve 'overflow-hidden' kombinasyonu sayfanın dışına taşmasını engeller.
...
        ${mobileMenuOpen ? 'translate-x-0' : '-translate-x-full'} flex flex-col shadow-2xl h-full
      `}>
